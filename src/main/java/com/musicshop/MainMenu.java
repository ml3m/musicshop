...
public class MainMenu {
    ...
    private void manageUsers() {
        ...
        switch (choice) {
            case 1 -> {
                ...
                users.forEach(System.out::println);  // Now this will print using the formatted toString
            }
            case 2 -> addNewUser();
            case 3 -> modifyUser();
    ...
    private void generateInventoryReport() {
        ...
        orders.forEach(order -> order.getCartItems().forEach(item -> {
        ...
        // Print Sold Items
        System.out.println("\n--- Sold Items ---");
        soldItems.forEach((item, quantity) -> System.out.println(item + ": " + quantity + " units sold"));

        // Print Inventory Items
        System.out.println("\n--- Inventory Items ---");
        items.forEach(item -> System.out.println(item.getName() + ": " + item.getQuantity() + " units in stock"));
